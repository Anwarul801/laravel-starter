...
class ThanaSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $thanas = [
            ...
            ['id' => '42', 'district_id' => '4', 'name' => 'Naniarchar', 'bn_name' => 'নানিয়ারচর', 'url' => 'naniarchar.rangamati.gov.bd'],
            ...
            // Dhaka City Thanas - district_id = 65
            ['id' => '492', 'district_id' => '65', 'name' => 'Adabor', 'bn_name' => 'আদাবর', 'url' => 'adabor.dhaka.gov.bd'],
            ['id' => '493', 'district_id' => '65', 'name' => 'Badda', 'bn_name' => 'বাড্ডা', 'url' => 'badda.dhaka.gov.bd'],
            ['id' => '494', 'district_id' => '65', 'name' => 'Banani', 'bn_name' => 'বনানী', 'url' => 'banani.dhaka.gov.bd'],
            ['id' => '495', 'district_id' => '65', 'name' => 'Bangshal', 'bn_name' => 'বংশাল', 'url' => 'bangshal.dhaka.gov.bd'],
            ['id' => '496', 'district_id' => '65', 'name' => 'Bimanbandar', 'bn_name' => 'বিমানবন্দর', 'url' => 'bimanbandar.dhaka.gov.bd'],
            ['id' => '497', 'district_id' => '65', 'name' => 'Cantonment', 'bn_name' => 'ক্যান্টনমেন্ট', 'url' => 'cantonment.dhaka.gov.bd'],
            ['id' => '498', 'district_id' => '65', 'name' => 'Chalkbazar', 'bn_name' => 'চকবাজার', 'url' => 'chalkbazar.dhaka.gov.bd'],
            ['id' => '499', 'district_id' => '65', 'name' => 'Dakshin Khan', 'bn_name' => 'দক্ষিণ খান', 'url' => 'dakshinkhan.dhaka.gov.bd'],
            ['id' => '500', 'district_id' => '65', 'name' => 'Darus-Salam', 'bn_name' => 'দারুস সালাম', 'url' => 'darussalam.dhaka.gov.bd'],
            ['id' => '501', 'district_id' => '65', 'name' => 'Demra', 'bn_name' => 'ডেমরা', 'url' => 'demra.dhaka.gov.bd'],
            ['id' => '502', 'district_id' => '65', 'name' => 'Dhanmondi', 'bn_name' => 'ধানমন্ডি', 'url' => 'dhanmondi.dhaka.gov.bd'],
            ['id' => '503', 'district_id' => '65', 'name' => 'Gandaria', 'bn_name' => 'গেন্ডারিয়া', 'url' => 'gandaria.dhaka.gov.bd'],
            ['id' => '504', 'district_id' => '65', 'name' => 'Gulshan', 'bn_name' => 'গুলশান', 'url' => 'gulshan.dhaka.gov.bd'],
            ['id' => '505', 'district_id' => '65', 'name' => 'Hazaribag', 'bn_name' => 'হাজারিবাগ', 'url' => 'hazaribag.dhaka.gov.bd'],
            ['id' => '506', 'district_id' => '65', 'name' => 'Jattrabari', 'bn_name' => 'যাত্রাবাড়ী', 'url' => 'jattrabari.dhaka.gov.bd'],
            ['id' => '507', 'district_id' => '65', 'name' => 'Kafrul', 'bn_name' => 'কাফরুল', 'url' => 'kafrul.dhaka.gov.bd'],
            ['id' => '508', 'district_id' => '65', 'name' => 'Kalabagan', 'bn_name' => 'কলাবাগান', 'url' => 'kalabagan.dhaka.gov.bd'],
            ['id' => '509', 'district_id' => '65', 'name' => 'Kamrangirchar', 'bn_name' => 'কামরাঙ্গীরচর', 'url' => 'kamrangirchar.dhaka.gov.bd'],
            ['id' => '510', 'district_id' => '65', 'name' => 'Khilgoan', 'bn_name' => 'খিলগাঁও', 'url' => 'khilgoan.dhaka.gov.bd'],
            ['id' => '511', 'district_id' => '65', 'name' => 'Khilkhet', 'bn_name' => 'খিলক্ষেত', 'url' => 'khilkhet.dhaka.gov.bd'],
            ['id' => '512', 'district_id' => '65', 'name' => 'Kodomtali', 'bn_name' => 'কদমতলী', 'url' => 'kodomtali.dhaka.gov.bd'],
            ['id' => '513', 'district_id' => '65', 'name' => 'Kotwali', 'bn_name' => 'কোতোয়ালী', 'url' => 'kotwali.dhaka.gov.bd'],
            ['id' => '514', 'district_id' => '65', 'name' => 'Lalbagh', 'bn_name' => 'লালবাগ', 'url' => 'lalbagh.dhaka.gov.bd'],
            ['id' => '515', 'district_id' => '65', 'name' => 'Mirpur Model', 'bn_name' => 'মিরপুর মডেল', 'url' => 'mirpur.dhaka.gov.bd'],
            ['id' => '516', 'district_id' => '65', 'name' => 'Mohammadpur', 'bn_name' => 'মোহাম্মদপুর', 'url' => 'mohammadpur.dhaka.gov.bd'],
            ['id' => '517', 'district_id' => '65', 'name' => 'Motijheel', 'bn_name' => 'মতিঝিল', 'url' => 'motijheel.dhaka.gov.bd'],
            ['id' => '518', 'district_id' => '65', 'name' => 'Mugda', 'bn_name' => 'মুগদা', 'url' => 'mugda.dhaka.gov.bd'],
            ['id' => '519', 'district_id' => '65', 'name' => 'New Market', 'bn_name' => 'নিউ মার্কেট', 'url' => 'newmarket.dhaka.gov.bd'],
            ['id' => '520', 'district_id' => '65', 'name' => 'Pallabi', 'bn_name' => 'পল্লবী', 'url' => 'pallabi.dhaka.gov.bd'],
            ['id' => '521', 'district_id' => '65', 'name' => 'Paltan', 'bn_name' => 'পল্টন', 'url' => 'paltan.dhaka.gov.bd'],
            ['id' => '522', 'district_id' => '65', 'name' => 'Ramna', 'bn_name' => 'রমনা', 'url' => 'ramna.dhaka.gov.bd'],
            ['id' => '523', 'district_id' => '65', 'name' => 'Rampura', 'bn_name' => 'রামপুরা', 'url' => 'rampura.dhaka.gov.bd'],
            ['id' => '524', 'district_id' => '65', 'name' => 'Rupnagar', 'bn_name' => 'রূপনগর', 'url' => 'rupnagar.dhaka.gov.bd'],
            ['id' => '525', 'district_id' => '65', 'name' => 'Sabujbag', 'bn_name' => 'সবুজবাগ', 'url' => 'sabujbag.dhaka.gov.bd'],
            ['id' => '526', 'district_id' => '65', 'name' => 'Shah Ali', 'bn_name' => 'শাহ আলী', 'url' => 'shahali.dhaka.gov.bd'],
            ['id' => '527', 'district_id' => '65', 'name' => 'Shahbag', 'bn_name' => 'শাহবাগ', 'url' => 'shahbag.dhaka.gov.bd'],
            ['id' => '528', 'district_id' => '65', 'name' => 'Shahjahanpur', 'bn_name' => 'শাহজাহানপুর', 'url' => 'shahjahanpur.dhaka.gov.bd'],
            ['id' => '529', 'district_id' => '65', 'name' => 'Sher e Bangla Nagar', 'bn_name' => 'শের-ই-বাংলা নগর', 'url' => 'sherebanglanagar.dhaka.gov.bd'],
            ['id' => '530', 'district_id' => '65', 'name' => 'Shyampur', 'bn_name' => 'শ্যামপুর', 'url' => 'shyampur.dhaka.gov.bd'],
            ['id' => '531', 'district_id' => '65', 'name' => 'Sutrapur', 'bn_name' => 'সুত্রাপুর', 'url' => 'sutrapur.dhaka.gov.bd'],
            ['id' => '532', 'district_id' => '65', 'name' => 'Tejgoan Industrial', 'bn_name' => 'তেজগাঁও শিল্প এলাকা', 'url' => 'tejgaonindustrial.dhaka.gov.bd'],
            ['id' => '533', 'district_id' => '65', 'name' => 'Tejgoan', 'bn_name' => 'তেজগাঁও', 'url' => 'tejgoan.dhaka.gov.bd'],
            ['id' => '534', 'district_id' => '65', 'name' => 'Turag', 'bn_name' => 'তুরাগ', 'url' => 'turag.dhaka.gov.bd'],
            ['id' => '535', 'district_id' => '65', 'name' => 'Uttar Khan', 'bn_name' => 'উত্তর খান', 'url' => 'uttarkhan.dhaka.gov.bd'],
            ['id' => '536', 'district_id' => '65', 'name' => 'Uttara East', 'bn_name' => 'উত্তরা পূর্ব', 'url' => 'uttaraeast.dhaka.gov.bd'],
            ['id' => '537', 'district_id' => '65', 'name' => 'Uttara West', 'bn_name' => 'উত্তরা পশ্চিম', 'url' => 'uttarawest.dhaka.gov.bd'],
            ['id' => '538', 'district_id' => '65', 'name' => 'Bashantek', 'bn_name' => 'বসন্তেক', 'url' => 'bashantek.dhaka.gov.bd'],
            ['id' => '539', 'district_id' => '65', 'name' => 'Vatara', 'bn_name' => 'ভাটারা', 'url' => 'vatara.dhaka.gov.bd'],
            ['id' => '540', 'district_id' => '65', 'name' => 'Wari', 'bn_name' => 'ওয়ারী', 'url' => 'wari.dhaka.gov.bd'],
            ['id' => '541', 'district_id' => '66', 'name' => 'Akbarshah Thana', 'bn_name' => 'আকবরশাহ থানা', 'url' => 'debidwar.comilla.gov.bd'],
            ['id' => '542', 'district_id' => '66', 'name' => 'Bakoliya Thana', 'bn_name' => 'বাকোলিয়া থানা', 'url' => 'debidwar.comilla.gov.bd'],
            ['id' => '543', 'district_id' => '66', 'name' => 'Bandar Thana', 'bn_name' => 'বন্দর থানা', 'url' => 'debidwar.comilla.gov.bd'],
            ['id' => '544', 'district_id' => '66', 'name' => 'Bayazid Thana', 'bn_name' => 'বায়জিদ থানা', 'url' => 'debidwar.comilla.gov.bd'],
            ['id' => '545', 'district_id' => '66', 'name' => 'Bhujpur Thana', 'bn_name' => 'ভুজপুর থানা', 'url' => 'debidwar.comilla.gov.bd'],
            ['id' => '546', 'district_id' => '66', 'name' => 'Chandgaon Thana', 'bn_name' => 'চন্দগন থানা', 'url' => 'debidwar.comilla.gov.bd'],
            ['id' => '547', 'district_id' => '66', 'name' => 'Chaowkbazar Thana', 'bn_name' => 'চকবাজার থানা', 'url' => 'debidwar.comilla.gov.bd'],
            ['id' => '548', 'district_id' => '66', 'name' => 'Chittagong Kotwali Thana', 'bn_name' => 'চিটাগাং থানা', 'url' => 'debidwar.comilla.gov.bd'],
            ['id' => '549', 'district_id' => '66', 'name' => 'Double Mooring Thana', 'bn_name' => 'ডাবল মর্নিং থানা', 'url' => 'debidwar.comilla.gov.bd'],
            ['id' => '550', 'district_id' => '66', 'name' => 'EPZ Thana Thana', 'bn_name' => 'ইপিজেড থানা', 'url' => 'debidwar.comilla.gov.bd'],
            ['id' => '551', 'district_id' => '66', 'name' => 'Halishahar Thana', 'bn_name' => 'হালিশাহার থানা', 'url' => 'debidwar.comilla.gov.bd'],
            ['id' => '552', 'district_id' => '66', 'name' => 'Karnaphuli Thana', 'bn_name' => 'কর্ণফুলি থানা', 'url' => 'debidwar.comilla.gov.bd'],
            ['id' => '553', 'district_id' => '66', 'name' => 'Khulshi Thana', 'bn_name' => 'খুলসি থানা', 'url' => 'debidwar.comilla.gov.bd'],
            ['id' => '554', 'district_id' => '66', 'name' => 'Kotwali Thana (Chittagong]', 'bn_name' => 'কতোয়াখালি থানা', 'url' => 'debidwar.comilla.gov.bd'],
            ['id' => '555', 'district_id' => '66', 'name' => 'Pahartali Thana', 'bn_name' => 'পাহারতলি থানা', 'url' => 'debidwar.comilla.gov.bd'],
            ['id' => '556', 'district_id' => '66', 'name' => 'Panchlaish Thana', 'bn_name' => 'পাঞ্চলাইস থানা', 'url' => 'debidwar.comilla.gov.bd'],
            ['id' => '557', 'district_id' => '66', 'name' => 'Patenga Thana', 'bn_name' => 'পতেংগা থানা', 'url' => 'debidwar.comilla.gov.bd'],
            ['id' => '558', 'district_id' => '65', 'name' => 'Gulshan Thana', 'bn_name' => 'গুলশান থানা', 'url' => 'debidwar.comilla.gov.bd'],
            ['id' => '559', 'district_id' => '65', 'name' => 'Banani Thana', 'bn_name' => 'বনানী থানা', 'url' => 'debidwar.comilla.gov.bd'],
            ['id' => '560', 'district_id' => '67', 'name' => 'Sadar Thana', 'bn_name' => 'সদর/জয়দেবপুর থানা', 'url' => 'debidwar.comilla.gov.bd'],
            ['id' => '561', 'district_id' => '67', 'name' => 'Bason Thana', 'bn_name' => 'বাসন থানা', 'url' => 'debidwar.comilla.gov.bd'],
            ['id' => '562', 'district_id' => '67', 'name' => 'Konabari Thana', 'bn_name' => 'কোনাবাড়ী থানা', 'url' => 'debidwar.comilla.gov.bd'],
            ['id' => '563', 'district_id' => '67', 'name' => 'Kashimpur Thana', 'bn_name' => 'কাশিমপুর থানা', 'url' => 'debidwar.comilla.gov.bd'],
            ['id' => '564', 'district_id' => '67', 'name' => 'Gacha Thana', 'bn_name' => 'গাছা থানা', 'url' => 'debidwar.comilla.gov.bd'],
            ['id' => '565', 'district_id' => '67', 'name' => 'Pubail Thana', 'bn_name' => 'পূবাইল থানা', 'url' => 'debidwar.comilla.gov.bd'],
            ['id' => '566', 'district_id' => '67', 'name' => 'Tongi West Thana', 'bn_name' => 'টঙ্গী পশ্চিম থানা', 'url' => 'debidwar.comilla.gov.bd'],
            ['id' => '567', 'district_id' => '67', 'name' => 'Tongi East Thana', 'bn_name' => 'টঙ্গী পূর্ব থানা', 'url' => 'debidwar.comilla.gov.bd'],
        ];
